...
from urls.site_urls import base_url, yandex_dzen_url
...
class HomePage(BaseClass):
    ...
    def click_button_order_by_locator(self, button_order_locator: Tuple[str, str]):
        self._move_element_and_click(button_order_locator)
